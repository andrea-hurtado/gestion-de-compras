...
public class RecuperarContraseniaView extends JInternalFrame {
    ...
    public void actualizarTextos() {
        ...
        if (lblRespondaPregunta != null)
            lblRespondaPregunta.setText(mensajeHandler.get("recuperar.lbl.responda.pregunta"));
        if (lblPreguntaSeguridad != null)
            lblPreguntaSeguridad.setText(mensajeHandler.get("recuperar.lbl.pregunta.seguridad"));
        if (lblNuevaContrasenia != null)
            lblNuevaContrasenia.setText(mensajeHandler.get("recuperar.lbl.nueva.contrasenia"));
